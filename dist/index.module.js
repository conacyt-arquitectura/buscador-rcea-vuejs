...
function (_super) {
  ...
  __decorate([Prop()], BuscadorRcea.prototype, "value", void 0);

  BuscadorRcea = __decorate([Component({
    components: {
...
export { BuscadorRceaComponent, Domicilio, EntidadFederativa, Institucion, PersonaFisica };
